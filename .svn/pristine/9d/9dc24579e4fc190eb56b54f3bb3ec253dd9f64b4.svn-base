		...
		<div class="col-xxl-12">
			...
			<div class="card">
				...
				<div class="card-header border-0 pt-5 pb-3">
					...
					<!--end::Card title-->
					<!--begin::Button-->
					<a href="<?php echo site_url('produk/tambah'); ?>" class="btn btn-success btn-sm my-2" tooltip="Tambah Produk">Tambah Produk</a>
					<!--end::Button-->
				</div>
				<!--end::Header-->
			</div>
					...
					<div class="col-md-4">
						...
						<div class="card card-flush h-md-100">
							...
							<div class="card-footer flex-wrap pt-0 text-center">
								<a href="<?php echo site_url('produk/sunting/' . encrypt_url($produk->id_produk)); ?>" class="btn btn-light btn-active-primary my-1 me-2">Sunting</a>
								<a href="<?php echo site_url('produk/detail/' . encrypt_url($produk->id_produk)); ?>" class="btn btn-light btn-active-success my-1 me-2">Detail</a>
							</div>
							<!--end::Card footer-->
						</div>
						<!--end::Card-->
