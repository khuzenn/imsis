            ...
            <div class="col-xxl-12">
                ...
                <div class="alert alert-dismissible bg-light-warning d-flex flex-column flex-sm-row w-100 p-5 mb-3">
                    ...
                    <div class="d-flex flex-column pe-0 pe-sm-10">
                        ...
                        <span>Gagal menambahkan data lini bisnis</span>
                    </div>
                    <!--end::Content-->
                    <!--begin::Close-->
        ...
        <div class="col-xxl-12">
            ...
            <div class="card">
                ...
                <div class="card-header border-0 pt-5 pb-3">
                    <!--begin::Card title-->
                    <h3 class="card-title fw-bolder text-gray-800 fs-2">Form Lini Bisnis</h3>
                    <!--end::Card title-->
                </div>
                <!--end::Header-->
                <!--begin::Body-->
                <form class="form-horizontal" role="form" action="<?php echo $action; ?>" method="POST">
                    <div class="card-body pt-0">
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="lini_bisnis" placeholder="Lini Bisnis" autocomplete="off" value="<?php if (isset($lini_bisnis)) {
                                                                                                                                                            echo $lini_bisnis;
                                                                                                                                                        } ?>">
                                <span style="color: red;"><?php echo form_error('lini_bisnis'); ?></span>
                            </div>
                        </div>
                    </div>
