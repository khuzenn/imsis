		...
		<div class="col-xxl-12 pe-0 pb-3">
			...
			<div class="card">
				...
				<div class="card-header border-0 pt-5 pb-3">
					<!--begin::Card title-->
					<h3 class="card-title fw-bolder text-gray-800 fs-2">List Kastemer</h3>
					<!--end::Card title-->
				</div>
				<!--end::Header-->
				<div class="card-body pt-0">
					<div class="">
						<table id="kt_datatable_example_kastemer" class="table table-striped table-row-bordered table-rounded table-striped table-hover border gy-5 gs-7" width="120%">
							...
							<tbody>
							<?php
							foreach ($list_kastemer as $kastemer) {
								?>
								<tr>
		...
		<div class="col-xxl-12 pe-0">
			<div class="card">
				...
				<div class="card-header border-0 pt-5 pb-3">
					...
					<!--end::Card title-->
					<a href="<?php echo site_url('produk/hapus/' . $id_produk); ?>" class="btn btn-danger btn-md" onclick="return confirm('Apakah Anda yakin untuk menghapus data produk ini?')">
								...
								<tr>
									...
									<td>
										<?php if (isset($file_brosur)) { ?>
											<a href="<?php echo base_url('produk/download/brosur/' . $id_produk); ?>" title="<?php echo $file_brosur ?>"><?php echo (strlen($file_brosur_full_name) > 20) ? substr($file_brosur_full_name, 0, 20) . "..." . $brosur_type[1] : $file_brosur_full_name; ?></a><?php } ?>
									</td>
								</tr>
								<tr>
									...
									<td>
										...
										foreach ($list_dataPresetasiProduk as $file_presentasi) {
											...
											?>
											<a href="<?php echo base_url('produk/download/presentasi/' . $id_produk . '/' . encrypt_url($file_presentasi->id_produk_presentasi)); ?>" title="<?php echo $file_presentasi->file_presentasi ?>">
				...
				<div class="card-footer">
					<center>
						<a href="<?php echo site_url('produk/tambah'); ?>" class="btn btn-success btn-sm">
							<i class="fal fa-plus"></i>&nbsp Tambah Produk
						</a>
						<a href="<?php echo site_url('produk/sunting/' . $id_produk); ?>" class="btn btn-primary btn-sm">
							<i class="fal fa-plus"></i>&nbsp Sunting Produk
						</a>
